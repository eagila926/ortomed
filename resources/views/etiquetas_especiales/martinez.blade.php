...
<div class="bloque-etiqueta">
  ...
  <div style="display:flex; justify-content:flex-end; margin-top:-90px; margin-right:-80px">
...
<script>
  ...
  // Regla: si hay más de una etiqueta, no se usa paciente manual
