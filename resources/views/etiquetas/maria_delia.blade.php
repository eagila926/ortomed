...
<style>
    ...
    .col-half { width: 65%; }
    .header { text-align: left; margin-top: 10px; margin-left: 10px; font-weight: bold; margin-bottom: 70px; }
    ...
    .nombre-etiqueta { font-size: {{ $fontSizeTitulo }}; font-weight: 60px; background: transparent; width: 100%; text-align: right; margin-left:-100px }
