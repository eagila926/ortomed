...
<style>
    ...
    .col { flex: 1; padding: 1px; font-size: 24px; }
    .col-half { width: 65%; }
    .header { text-align: center; margin-top: 10px; margin-left: 30px; font-weight: bold; margin-bottom: 15px; }
    ...
    .nombre-etiqueta { font-size: {{ $fontSizeTitulo }}; font-weight: 700; background: transparent; width: 100%; text-align: center; }
    ...
    .comp-nombre { font-weight: bold; font-size: 24px; }
...
<div class="container">
    ...
    <div class="footer" style="{{ $espaciadoExtra }}">
        ...
        <p class="fabri" style="font-size:20px; display:block; text-align:right; margin-right:-10px">
