            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="index.php" id="" role="button" data-bs-toggle="link" aria-haspopup="true" aria-expanded="false">
                            <i class="ri-home-4-line"></i>Escollanos
                        </a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ri-apps-line"></i>Producción <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            <a href="formulas-establecidas.php" class="dropdown-item">Formulas Establecidas</a>
                            <a href="formulas-no-establecidas.php" class="dropdown-item">Formulas Nuevas</a>
                            <a href="apps-kanban.php" class="dropdown-item">Formulas Recientes</a>
                        </div>
                    </li>

                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-apps" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ri-qq-fill"></i>Usuarios <div class="arrow-down"></div>
                        </a>
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            <a href="registrar-user.php" class="dropdown-item">Registrar usuario</a>
                            <a href="apps-chat.php" class="dropdown-item">Listar Usuarios</a>
                        </div>
                    </li>
